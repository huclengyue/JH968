...
public class Alarm_CountDownSetActivity extends BaseActivity {
	...
	private void Init() {
		...
		/*
		 * tv1.setText(""+ gCountdaownTime/60); tv2.setText(":"); //
		...
		if (keyCode == KeyEvent.KEYCODE_ENTER || keyCode == KeyEvent.KEYCODE_DPAD_CENTER) {
			...
			if (gCountdaownTime > 0) {
				...
				PromptDialog mPromptDialog = new PromptDialog(this,
						getResources().getString(R.string.count_down_set_error));
				mPromptDialog.show();
			...
			ConfirmDialog gConfirmDialog = new ConfirmDialog(this,
					getResources().getString(R.string.canel_set_countdown), getResources().getString(R.string.ok),
