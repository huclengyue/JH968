...
public class Alarm_SettingActivity extends BaseActivity {
	...
	public boolean onKeyUp(int keyCode, KeyEvent event) {
		...
		// 确认键
		if (keyCode == KeyEvent.KEYCODE_ENTER || keyCode == KeyEvent.KEYCODE_DPAD_CENTER) // 确认键
		{
	...
	private void goBackAskTime() {
		...
		Global.debug("[goBackAskTime] onKeyDown gMin === " + gMin);
		Global.debug("[goBackAskTime] onKeyDown gHour === " + gHour);
