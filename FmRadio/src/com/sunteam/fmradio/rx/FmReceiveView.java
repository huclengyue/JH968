...
package com.sunteam.fmradio.rx;
...
public class FmReceiveView extends FrameLayout implements View.OnClickListener,
     ...
     */
	public static int HIGH_SIGNAL_STRENGTH = 83;
    public static int MEDIUM_SIGNAL_STRENGTH = 91;
    public static int LOW_SIGNAL_STRENGTH = 99;
   ...
   // private ImageView digit1, digit2, digit3, digit4, digit5;
    ...
    //private FmRadioFrequencySlider slider;  // 滑块
...
//        digit5 = (ImageView) findViewById(R.id.freq_digit5);
    ...
    public void setFrequencyGraphics(int freq) {
       // this.frequency = freq;
       // slider.setFreq(freq);
...
/*        rdsPsView.setText(null);
    ...
    public void setMinMaxFrequencies(int minFreq, int maxFreq) {
...
//        this.frequencyStep = frequencyStep;
    ...
    public synchronized void setSeekStatus(boolean seekInProgress, boolean tuneInProgress) {
        /*findViewById(com.sunteam.fmradio.R.id.seek_indicator).setVisibility(
